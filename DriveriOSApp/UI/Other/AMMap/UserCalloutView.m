...
-(void)creatUI{
    ...
    [self.timeBtn setTitleColor:TAB_SELECT_TEXTCOLOR forState:UIControlStateNormal];
    [self.timeBtn setBackgroundImage:[UIImage imageNamed:@"timeAnno"] forState:UIControlStateNormal];
    
    [self addSubview:self.timeBtn];
    
    self.titleLable = [FactoryClass labelWithFrame:CGRectMake(MATCHSIZE(80), MATCHSIZE(10), MATCHSIZE(180), MATCHSIZE(60)) TextColor:TAB_SELECT_TEXTCOLOR fontBoldSize:MATCHSIZE(30)];
...
- (void)drawRect:(CGRect)rect
{
    ...
    self.layer.shadowColor = TAB_SELECT_TEXTCOLOR.CGColor;
