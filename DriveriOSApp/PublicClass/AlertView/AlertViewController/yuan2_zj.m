...
-(void)chushihua{
    ...
    _array1 = [NSArray arrayWithObjects:(id)[[UIColor colorWithHex:0xff0000] CGColor],(id)[[UIColor colorWithHex:0xfa3088] CGColor],(id)[[UIColor colorWithHex:0xfa7088] CGColor], nil];
    _array2 = [NSArray arrayWithObjects:(id)[[UIColor colorWithHex:0xfac4b7]  CGColor],(id)[[UIColor colorWithHex:0xfa7088] CGColor], nil];
    _gradientlayer1.locations = @[@(0.05),@(0.25),@(0.7)];
...
- (void)setcanshu:(CGRect)rect{
    ...
    [_apath addArcWithCenter:_point radius:_bj - 2 startAngle:- M_PI / 2 + M_PI*6/180 endAngle:M_PI*2 clockwise:YES];
...
-(void)addBackgroundCircle
{
    ...
    [pathT addArcWithCenter:_point radius:_bj-2 startAngle:0 endAngle:M_PI*2 clockwise:YES];
   
    backgrounLayer.path = pathT.CGPath;
    backgrounLayer.fillColor = [UIColor clearColor].CGColor;
    backgrounLayer.lineWidth = _zj_kd;
    backgrounLayer.strokeColor = [UIColor colorWithHex:0xdcdcdc].CGColor;
